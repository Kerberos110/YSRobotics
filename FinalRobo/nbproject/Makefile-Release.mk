...
${OBJECTDIR}/Behaviors/MoveForward.o: Behaviors/MoveForward.cpp 
	${MKDIR} -p ${OBJECTDIR}/Behaviors
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Behaviors/MoveForward.o Behaviors/MoveForward.cpp

${OBJECTDIR}/Behaviors/Movement.o: Behaviors/Movement.cpp 
	${MKDIR} -p ${OBJECTDIR}/Behaviors
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Behaviors/Movement.o Behaviors/Movement.cpp
